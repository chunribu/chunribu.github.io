...
export const metadata = {
  title: "Privacy Policy - Bouncing Ball Duel Mobile",
  description: "Privacy Policy for Bouncing Ball Duel Mobile, a free offline Android game developed by PCC Free Space.",
};
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-12">
          <h1 className="text-4xl font-bold tracking-tight text-foreground mb-6 animate-fade-in-up">
            Privacy Policy for Bouncing Ball Duel Mobile
          </h1>
          <p className="text-sm text-muted-foreground">
            <strong>Effective Date: July 9, 2026</strong>
          </p>
        </div>

        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="text-muted-foreground">
            Thank you for playing Bouncing Ball Duel Mobile (&quot;the game,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), a mobile offline game developed by PCC Free Space. We are committed to protecting your privacy. This game is completely free, contains no advertisements, and does not collect any of your personal data. This Privacy Policy explains our commitment to your privacy.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">1. Information We Collect</h2>
          <p className="text-muted-foreground">
            <strong>We do not collect any personal information.</strong> Bouncing Ball Duel Mobile is an offline game. We do not collect, store, or have access to any personal or sensitive user data, such as your name, email address, location, or device identifiers.
          </p>
          <p className="text-muted-foreground">
          ...
          <p className="text-muted-foreground">
            We may update this Privacy Policy from time to time. Since the game is offline and does not collect data, we anticipate any changes will be minor. We encourage you to review this policy periodically.
          </p>
        </div>
